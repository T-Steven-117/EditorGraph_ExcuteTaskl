...
#include "EdGraphSchema_MissionObject.generated.h"
...
USTRUCT()
struct FMissionObjectSchemaAction_AutoArrange : public FEdGraphSchemaAction
{
	GENERATED_USTRUCT_BODY();

	FMissionObjectSchemaAction_AutoArrange() 
		: FEdGraphSchemaAction() {}

	FMissionObjectSchemaAction_AutoArrange(FText InNodeCategory, FText InMenuDesc, FText InToolTip, const int32 InGrouping)
...
UCLASS(MinimalAPI)
class UEdGraphSchema_MissionObject : public UMOGraphSchema
{
